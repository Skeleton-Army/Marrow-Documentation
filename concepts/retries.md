---
description: How to utilize RetryCommand
---
...
Imagine this scenario: in a deciding match, your auto sequence fails to grab a game element properly. Without any error-detection system, that single failure could cost your team the win.
...
As you can see, these retries mean the difference between a poor auto run and a consistently reliable one. Even recovering just a couple more points can be the tiebreaker in close matches.
